...
<body style="background: floralwhite;">
  <div class="container" style="text-align: center; margin-top: 10px; margin-right:20px;">

    <div class="card-header" style="text-align:center; margin-right:100px;">
      <marquee>
        <h2>Monitoring Data Suhu, Kelembaban, dan PH Secara Realtime</h2>
      </marquee>
    </div>
    ...
    <div style="display: flex; margin-top:2px; margin-right:100px;">
      ...
      <div class="alert alert-primary d-flex align-items-center" role="alert" style="width: 50%">
